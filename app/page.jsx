            ...
            <div className="flex-1 bg-[#fdfbf7] p-8 rounded-[2rem] border border-slate-100 w-full text-sm">
              ...
              <div className="flex gap-6 mt-6 pt-6 border-t border-slate-200">
                ...
                <div>
                  ...
                  <a href="https://www.linkedin.com/in/awaliawd/" target="_blank" rel="noopener noreferrer" className="font-serif text-slate-800 hover:text-emerald-500 underline decoration-emerald-300">awaliawd</a>
                </div>
              </div>
            </div>
          </div>
